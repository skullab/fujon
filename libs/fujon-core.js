...
Object.prototype.isNotPrototypeFunction = function(name){
  var c = true ;
  for(var f in fujon.constants.OBJECT.PROTOTYPE.FUNCTIONS){
    if(name == f){
      c = false ;
      break ;
    }
     ...
     for(var property in object){
      ...
      if(tag_property.length > 1){
        ...
        if(property == 'constructor'){
          ...
          //if(object[property] == primitive._super[property])alert('override');
    ...
    if(object instanceof Object){
      for(var abstract_property in object){
        if(abstract_property == 'implement'){
          if(!fujon.core.isArray(object[abstract_property]) && object[abstract_property] != '[object Interface]')alert('error imple');
          if(fujon.core.isArray(object[abstract_property])){
            for(var i=0 ; i<object[abstract_property].length;i++){
              if(object[abstract_property][i] != '[object Interface]')alert('error array :'+i);
        ...
        }else this[abstract_property] = object[abstract_property];
      }
      var _this = this ;
          ...
          if(object instanceof Object){
            for(var implement in object){
              ...
              for(var implement_to_override in this){
                if(implement_to_override != 'constructor' && implement_to_override != 'toString' && implement_to_override != 'implement'){
                  if(!object[implement_to_override])throw ERROR.CORE.IllegalInterfaceMethod ;
                  if(implement == implement_to_override){check = true;}
                  this[implement_to_override] = object[implement_to_override] ;
                }
              }
              if(!check)throw ERROR.CORE.IllegalInterfaceMethod ;
            }
          }
        },
        extend: _this,
        toString: function(){return '[object Interface]';}
      }) ;
    }
  }
});
...
fujon.core.MouseListener = new fujon.core.Interface({
  implement:[fujon.core.OnClickListener,fujon.core.OnDoubleClickListener,fujon.core.OnMouseDownListener,fujon.core.OnMouseMoveListener,fujon.core.OnMouseOutListener,fujon.core.OnMouseOverListener,fujon.core.OnMouseUpListener]
});
// LOADER GROUP
fujon.core.LoaderListener = new fujon.core.Interface({
  implement:[fujon.core.OnErrorListener,fujon.core.OnLoadListener,fujon.core.OnUnloadListener]
});
//KEYBOARD GROUP
fujon.core.KeyboardListener = new fujon.core.Interface({
  implement:[fujon.core.OnKeyDownListener,fujon.core.OnKeyPressListener,fujon.core.OnKeyUpListener]
});
/*----------------------------------------
            CORE
              +> ListenerManager
...
fujon.core.ListenerManager = new function(){
   ...
   * Return true if add or false otherwise
   */     
...
fujon.core.Element = new fujon.core.Class({
  constructor: function(type){
    ...
    create: function(type){
      if(type != null){
        if(!fujon.core.isString(type))throw ERROR.CORE.IllegalTypeAssignment ;
        this.typeElement = type ;
        this.elementObject = document.createElement(this.typeElement);
      }
    },
        ...
        case 1:
          if(fujon.core.isObject(arguments[0])){
            for(var name in arguments[0]){
              if(arguments[0].isNotPrototypeFunction(name)){
                if(!fujon.core.isString(arguments[0][name]))throw ERROR.CORE.IllegalTypeAssignment ;
                this.elementObject.setAttribute(name,arguments[0][name]);
              }
            }
          }else throw ERROR.CORE.IllegalTypeAssignment ;
          break;
        case 2:
          if(fujon.core.isString(arguments[0]) && fujon.core.isString(arguments[1])){
            this.elementObject.setAttribute(arguments[0],arguments[1]);
          }else throw ERROR.CORE.IllegalTypeAssignment ;
      }
      
    },
    getAttribute: function(attr){
      if(!fujon.core.isString(attr))throw ERROR.CORE.IllegalTypeAssignment ;
    ...
    setOnBlurListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'blur',function(e){_this.blurListener.onBlur(_this,e)});
      }
    },
    setOnChangeListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'change',function(e){_this.changeListener.onChange(_this,e)});
      }
    },
    setOnClickListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'click',function(e){_this.clickListener.onClick(_this,e)});
      }
    },
    setOnDoubleClickListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'dblclick',function(e){_this.dblclickListener.onDblClick(_this,e)});
      }
    },
    setOnErrorListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'error',function(e){_this.errorListener.onError(_this,e)});
      }
    },
    setOnFocusListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'focus',function(e){_this.focusListener.onFocus(_this,e)});
      }
    },
    setOnKeyDownListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'keydown',function(e){_this.keydownListener.onKeyDown(_this,e)});
      }
    },
    setOnKeyPressListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'keypress',function(e){_this.keypressListener.onKeyPress(_this,e)});
      }
    },
    setOnKeyUpListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'keyup',function(e){_this.keyupListener.onKeyUp(_this,e)});
      }
    },
    setOnLoadListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'load',function(e){_this.loadListener.onLoad(_this,e)});
      }
    },
    setOnUnloadListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'unload',function(e){_this.unloadListener.onUnload(_this,e)});
      }
    },
    setOnMouseDownListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'mousedown',function(e){_this.mousedownListener.onMouseDown(_this,e)});
      }
    },
    setOnMouseUpListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'mouseup',function(e){_this.mouseupListener.onMouseUp(_this,e)});
      }
    },
    setOnMouseOutListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'mouseout',function(e){_this.mouseoutListener.onMouseOut(_this,e)});
      }
    },
    setOnMouseOverListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'mouseover',function(e){_this.mouseoverListener.onMouseOver(_this,e)});
      }
    },
    setOnMouseMoveListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'mousemove',function(e){_this.mousemoveListener.onMouseMove(_this,e)});
      }
    },
    setOnResizeListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'resize',function(e){_this.resizeListener.onResize(_this,e)});
      }
    },
    setOnSelectListener: function(listener){
      if(fujon.core.ListenerManager.checkListener(listener)){
        ...
        var _this = this ;
        fujon.core.ListenerManager.addListener(this.elementObject,'select',function(e){
        var selection = window.getSelection || document.getSelection ;
        if(!selection && document.selection) selection = function(){ return document.selection.createRange().text} ;
        if(!selection) selection = function(){return null} ;
        _this.selectListener.onSelect(_this,selection(),e) ;
        });
      }
    },
    toString: function(){
...
fujon.core.Pointer = new fujon.core.Class({
    ...
    get: function(obj){
        if(isNaN(obj)){
            for(i=0;i<this.ojects.length;i++){
                if(this.objects[i] == obj) return this.objects[i];
            }
        }else return this.objects[obj];
        return false ;
    },
...
fujon.core.thread = {
    ...
    /** WAIT singleton object
    *   Usage : return WAIT.set(milliseconds)
    *   Use this only inside a Thread 
    **/ 
    WAIT: new function(){
        var _this = this ;
    ...
    START:{toString:function(){return '[object START]'}},
    CONTINUE:{toString:function(){return '[object CONTINUE]'}},
    STOP:{toString:function(){return '[object STOP]'}},
    KILL:{},
    Generator: function(maxStack){
        var cursor = 0 ;
        return {
        next: function(){
            if(isNaN(maxStack))return maxStack ;
            if(cursor < maxStack){
                return (cursor += 1);
            }else throw ERROR.GENERATOR.StopIteration ;
        },
        set: function(value){
            if(value != null) maxStack = value ;
        },
        send: function(value){
            if(value != null)cursor = value ;
            return this.next();
        },
        hasNext: function(){
            try{
        ...
        _throw: function(error,msg){
            ...
            }else throw ERROR.GENERATOR._throw ;
        }};
    },
...
fujon.core.thread.Thread.prototype = {
    ...
    start: function(){
       if(!this.isStarted()){
            ...
            return this ;
       }else throw ERROR.THREAD.IllegalThreadStateException ;
    },
