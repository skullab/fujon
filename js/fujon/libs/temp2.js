 ...
 * -> var MyBaseClass = Class({modifier:'abstract'},{define class here...}); THIS CANNOT BE INSTANTIATED
...
fujon.core.Class = function() {
	...
	function addProperty(object) {
		...
		var context = parent && parent._super ? parent : this ;
		console.log('Have parent ? ->');
		console.log(parent);
		
    var properties = fujon.core.keysOf(object);
    
    for(var i = 0 ; i < properties.length ; i++){
      property = properties[i] , value = object[property] ;
       if (parent != undefined && parent[property] != undefined && typeof parent[property] === 'function') {
